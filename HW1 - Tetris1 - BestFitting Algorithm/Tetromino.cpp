...
void Tetromino::init(Tetromino_t tetrominoType) {
	switch(tetrominoType) {
		...
		case Tetromino_t::T :
			blocks[0][0] = blocks[1][0] = blocks[2][0] = blocks[1][1] = 'T';
			setActualBlocks();
		...
		case Tetromino_t::J :
			blocks[0][1] = blocks[1][1] = blocks[2][1] = blocks[2][0] = 'J';
			setActualBlocks();
		...
		case Tetromino_t::L :
			blocks[0][0] = blocks[0][1] = blocks[1][1] = blocks[2][1] = 'L';
			setActualBlocks();
		...
		case Tetromino_t::Z :
			blocks[0][1] = blocks[1][1] = blocks[1][0] = blocks[2][0] = 'Z';
			setActualBlocks();
